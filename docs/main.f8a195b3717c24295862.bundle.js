...
(0, _react.addDecorator)((0, _storybookReactRouter.default)()); // Import setup files

var importAll = r => r.keys().forEach(r);

importAll(__webpack_require__("./src sync recursive storybook\\.setup\\.[jt]sx?$")); // Require all *.story.js file
...
function useBreakpoint(defaultValue, breakpointValues) {
  const [[innerWidth, innerHeight], setInnerWidth] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(cachedIw);
  ...
  return Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(() => calculateValue(defaultValue, breakpointValues, innerWidth, innerHeight), [innerWidth, defaultValue]);
}

__signature__(useBreakpoint, "useState{[[innerWidth, innerHeight], setInnerWidth](cachedIw)}\nuseResize{}\nuseMemo{}", () => [___WEBPACK_IMPORTED_MODULE_1__["useResize"]]);
...
//# sourceMappingURL=main.f8a195b3717c24295862.bundle.js.map